    ...
    mifosX.services = _.extend(module, {
        AuthenticationService: function (scope, httpService, SECURITY, localStorageService,timeout, webStorage) {
            ...
            var getAccessToken = function(){
                ...
                httpService.post( "/lsplatform/api/oauth/token?&client_id=community-app&grant_type=refresh_token&client_secret=123&refresh_token=" + refreshToken)
            ...
            this.authenticateWithUsernamePassword = function (credentials) {
        		...
        		if(SECURITY === 'oauth'){
	                httpService.post( "/lsplatform/api/oauth/token?username=" + credentials.username + "&password=" + credentials.password +"&client_id=community-app&grant_type=password&client_secret=123")
